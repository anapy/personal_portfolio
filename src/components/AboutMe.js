  ...
  <div className="aboutMe">
    ...
    <div className="aboutMe_info">
      ...
      <article className="studies">
        <h3 className="article_aboutMe_title">Formación Académica</h3>
      ...
      <article className="tecnologies">
        <h3 className="article_aboutMe_title">Conocimientos en tecnologías</h3>
      ...
      <article className="hobbies">
        <h3 className="article_aboutMe_title">Idiomas</h3>
        <p>Inglés - C1</p>
        <p>Alemán - B2</p>
      </article>
      </div>
